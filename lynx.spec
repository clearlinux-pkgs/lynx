...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689791780
...
cp %{_builddir}/lynx%{version}/COPYING %{buildroot}/usr/share/package-licenses/lynx/4040d546c58c33203dd42955add5c460400c4010 || :
cp %{_builddir}/lynx%{version}/PACKAGE/debian/copyright %{buildroot}/usr/share/package-licenses/lynx/e21be8436fdd89b040da444fe004d0a0b7c4b4dc || :
cp %{_builddir}/lynx%{version}/WWW/Library/vms/COPYING.LIB %{buildroot}/usr/share/package-licenses/lynx/ba8966e2473a9969bdcab3dc82274c817cfd98a1 || :
%make_install
%find_lang lynx
